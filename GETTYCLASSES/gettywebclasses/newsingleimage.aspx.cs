...
{
    public partial class newsingleimage : System.Web.UI.Page
    {
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            try
            {
                newsingleimagemgmt _objdata = new newsingleimagemgmt();
                if (txtsearch.Text != "")
            ...
            try
            {
                ...
                foreach (DataListItem _chk in gettydata.Items)
                {
                    ...
                    if (_selchk.Checked)
                    {
                        ...
                        _imagesselect=_selectedID.Value;
                      //  newsingleimagemgmt _objdata = new newsingleimagemgmt();
                        newsingleimagemgmt _objdata = new newsingleimagemgmt();
                        ...
                        //getdownload images.
                        imagename = _objdata.GetdownloadsingleimagesLiveUpdate(_imagesselect);
                       
                        break;
                    }

                }
                ScriptManager.RegisterStartupScript(this, this.GetType(), "close", "setimage(\"" + imagename + "\");", true);

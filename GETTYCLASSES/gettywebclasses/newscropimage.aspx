<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newscropimage.aspx.cs" Inherits="gettywebclasses.newscropimage" %>
<HTML>
	<HEAD>
		        ...
		        reader.onloadend = function () {
		            ...
		            img.onload = function () {
		                ...
		                if (w > 300 && h > 280) {
		                    ...
		                    cropper = new Darkroom('#target', { minWidth: 300, minHeight: 201, maxWidth: 900, maxHeight: 603, plugins: { crop: { quickCropKey: 67, minHeight: 201, minWidth: 300} }, init: function () { var cropPlugin = this.getPlugin('crop'); cropPlugin.selectZone(al, at, pw, ph); }

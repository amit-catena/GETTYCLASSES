<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="singleimagecrop.aspx.cs" Inherits="gettywebclasses.singleimagecrop" %>
		            ...
		            img.onload = function () {
		                ...
		                if (w > 150 && h > 100) {
		                  ...
		                  //  cropper = new Darkroom('#target', { minWidth: 300, minHeight: 201, maxWidth: 1300, maxHeight: h, plugins: { crop: { quickCropKey: 67, minHeight: 201, minWidth: 300} }, init: function () { var cropPlugin = this.getPlugin('crop'); cropPlugin.selectZone(al, at, pw, ph); }
                            ...
                            cropper = new Darkroom('#target', { minWidth: 200, minHeight: 310, maxWidth: 1300, maxHeight: 600, plugins: { crop: { quickCropKey: 67, minHeight: 80, minWidth: 140} }, init: function () { var cropPlugin = this.getPlugin('crop'); cropPlugin.selectZone(25, 15, 140, 80); }
		                    });
		                    //parent.updateHeight();
		                } else {                            

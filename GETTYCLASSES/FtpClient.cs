...
namespace Gettyclasses
{
    public class FtpClient
    {
        ...
        ///<summary>
        /// Returns the list of directory and files present in current directory
        /// </summary>
        /// <returns></returns>
        public string[] LIST()
        {
        ...
        {
            this.UploadDirectory1(path, recurse, "*.*");
        }
        public void UploadDirectory1(string path, bool recurse)
        {
            this.UploadDirectory1(path, recurse, "*.*");
        }
        ...
        public void UploadDirectory(string path, bool recurse, string mask)
        {
            ...
            //string rootDir = dirs[dirs.Length];
        ...
        public void UploadDirectory1(string path, bool recurse, string mask)
        {
            string[] dirs = path.Replace("/", @"\").Split('\\');
            string rootDir = dirs[dirs.Length - 1];

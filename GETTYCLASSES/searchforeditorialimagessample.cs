...
namespace ConnectExample.Samples
{
    ...
    public class SearchForEditorialImagesSample
    {
        ...
        public int _endcnt { get; set; }
        public int _eventID { get; set; }
        // token received from CreateSession/RenewSession API call
        public SearchForImagesResponse Search(string token,string termpharse)
        {
            var searchForImagesRequest = new SearchForImagesRequest
            {
                ...
                {
                    Query = new Query { SearchPhrase = !string.IsNullOrEmpty(termpharse) ? termpharse : SearchTerm},
